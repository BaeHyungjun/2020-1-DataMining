...
##### (a) fit polynomial regression using cv methods as (1) validation set, (2) LOOCV, (3) 10-fold cv
...
##### (b) fit knn regression using cv methods as (1) validation set, (2) LOOCV, (3) 10-fold cv
